...
export default function InstructionsPage() {
  return (
    <div className="min-h-screen bg-marion-light py-12 px-6">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
        <h2 className="text-4xl font-bold text-marion text-center mb-8">
          The LoonTune
        </h2>
        ...
        <section className="mb-12">
          <h4 className="text-xl font-bold text-marion text-center mb-4">
        ...
        <section className="mt-16 p-6 bg-marion-lightest rounded-lg shadow-md border border-marion">
          <h4 className="text-2xl font-bold text-marion text-center mb-4">
            How to Use Your LoonTune
          </h4>
          <p className="text-center text-gray-700 mb-4">
            Follow these simple steps to enjoy the authentic calls of the loon.
          </p>
          <ol className="list-decimal list-inside space-y-4 bg-white p-6 rounded-lg shadow">
            <li className="text-marion">
          ...
          <p className="mt-6 text-center text-black-600 font-semibold">
